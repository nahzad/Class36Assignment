       ...
       <!-- Formdatatable -->
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Create Blogs</h5>
                ...
                <form class="form-horizontal" action="{{ route('blogs.store') }}" method="POST" >
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="sub_title" class="form-control" placeholder="Sub Title here ">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-2">Description</label>
                            <div class="col-lg-10">
                                <textarea name="description" rows="5" cols="5" class="form-control" placeholder="Description here"></textarea>
                            </div>
                        </div>
                        {{-- <div class="form-group">
